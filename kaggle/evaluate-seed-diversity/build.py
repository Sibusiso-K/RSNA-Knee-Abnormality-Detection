"""CUDA evaluator for experiment 3 (docs/15): does a second 24-epoch small
seed add ensemble value on top of the existing small+base 24-epoch pair?

Folds 0 and 1 only (the pilot). Inference only - no retraining/submission.

Usage: python kaggle/evaluate-seed-diversity/build.py OUTPUT_DIRECTORY
...
''' + source[end:]
    ...
    ast.parse(source)
    metadata = {
        "id": "sibusisokhumalo11/knee-evaluate-seed-diversity",
        "title": "knee-evaluate-seed-diversity",
        "code_file": "script.py",
        "language": "python",
        "kernel_type": "script",
        "is_private": True,
        ...
        "dataset_sources": [
            ...
            "sibusisokhumalo11/knee-slot-seed1-pilot-v1",
        ],
    ...
    print(f"Built seed-diversity evaluator -> {output}")
